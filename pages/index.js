  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Japps - Mídia e Tecnologia" key="title" />
        <meta name="theme-color" content="#1e69da" />
      </Head>
      <div className={styles.container}>
        <h1 className={styles.title}>Japps - Mídia e Tecnologia</h1>
        <div className={styles.bear__wrap}>
          <div ref={swearRef} className={styles.bear__swear}>
            #@$%*!
        </div>
          <svg
            ref={bearRef}
        ...
        <div ref={armWrapRef} className={styles.bear__arm_wrap}>
          <svg
            ref={armRef}
            className={styles.bear__arm}
        ...
        <div ref={pawRef} className={styles.bear__paw} />
        <div className={styles.mask} />
        <div className={styles.checkbox} onMouseOver={onHover} onMouseOut={offHover}>
